...
if __name__ == '__main__':
    # allServices = DubboInterfaceService.getAllServices("IMgrab-test3-httpconf","asdf")
    allServices = DubboInterfaceService.getAllServices("test1","dubbo-mls-biz-quality")
    print(allServices)

    allMethods = DubboInterfaceService.getAllMethods("test1","dubbo-mls-biz-quality","com.lianjia.mls.quality.api.rpc.TrueHouseTaskFacade")
    print(allMethods)