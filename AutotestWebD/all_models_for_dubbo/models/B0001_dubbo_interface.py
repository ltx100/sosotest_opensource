...
class Tb2DubboInterface(models.Model):
    ...
    dubboSystem = models.CharField(max_length=100,db_column='dubboSystem', verbose_name="dubbo的project名称，比如mls-biz-support")
    dubboService = models.CharField(max_length=200,db_column='dubboService',  verbose_name="dubbo的service全路径，比如com.lianjia.mls.business.quality.facade.SharePoolHouseFacade")
