...
if __name__ == '__main__':
    rt = MongoTool("10.26.9.107",27027)
    rt.refresh_collect("wjltest","reports").insert({"id":3,"name":"wangjiliang3"})
    rt.insert({"id":4,"name":"wangjiliang4"})
    # print(rt.insert({"id":1,"name":"wangjiliang"}))
    # print(rt.insert({"id":2,"name":"wangjiliang2"}))
    # print(rt.insert({"id":3,"name":"wangjiliang3"}))
    # rt.update({"id":1},{"$set":{"name":"wangjiliangreset"}})
    # rt.update({"id":1},{"$set":{"name":"wangjiliangreset2"}},multi=False)
    # rt.update({"id":5},{"$set":{"name":"wangjiliangreset"}},upsert=True)
    # rt.remove({"id":3})
